...
public class BlurBackground {
    ...
    public BlurBackground(Context context, int radius) {
    ...
    public void blur()
    {
//        sentBitmap = takeScreenShot((Activity)context);
//        sentBitmap = fastblur(sentBitmap,radius);
...
//        b.setDensity(1);
    ...
    private class AsyncTaskLoad extends AsyncTask{
        @Override
